...
REQUIRED = {
    ...
    "references/image-composition.md",
    "references/manifest.md",
    "scripts/compose_score_images.py",
...
FLAT_SOURCE_NAMES = {
    ...
    "references/image-composition.md": "image-composition.md",
    "references/manifest.md": "manifest.md",
    "scripts/compose_score_images.py": "compose_score_images.py",
