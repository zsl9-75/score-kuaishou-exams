...
```text
请使用 $skill-installer 从 https://github.com/zsl9-75/score-kuaishou-exams 安装这个 Skill。
```

不要只复制 `SKILL.md`，也不要把仓库文件摊平到同一目录。完整目录必须保留 `scripts/`、`references/` 和 `agents/`。如需手动打包，运行：
